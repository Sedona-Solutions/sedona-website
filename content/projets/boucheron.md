...
defis:
  ...
  points:
    ...
    - titre: Performance & fluidité
      texte: Des images lourdes servies sans ralentir l'expérience.
    - titre: Cohérence de marque
      texte: Respecter une direction artistique exigeante.
approche:
  titre: Une expérience à la hauteur de la maison
  points:
    - titre: Direction artistique soignée
      texte: Chaque détail au service de l'élégance.
    - titre: Médias optimisés
      texte: Qualité visuelle et chargement maîtrisé.
    - titre: Animations subtiles
