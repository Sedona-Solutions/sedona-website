...
defis:
  ...
  points:
    ...
    - titre: Lisibilité de l'information
      texte: Rendre la statistique compréhensible par tous.
    - titre: Accessibilité (RGAA)
      texte: Un service public inclusif.
approche:
  titre: De la donnée brute à l'information utile
  points:
    - titre: Architecture de l'information
      texte: Une navigation claire dans un large corpus.
    - titre: DataViz lisibles
      texte: Des visualisations qui éclairent la donnée.
    - titre: Recherche puissante
