...
defis:
  ...
  points:
    ...
    - titre: Identité visuelle forte
      texte: Restituer l'ADN du lieu sur le web.
    - titre: Pic de trafic
      texte: Tenir la charge lors des mises en vente.
approche:
  titre: Un site vivant et facile à administrer
  points:
    - titre: Direction artistique sur mesure
      texte: Une interface fidèle à l'esprit de la salle.
    - titre: Gestion de la programmation
      texte: Un back-office simple pour l'équipe.
    - titre: Parcours billetterie fluide
