...
defis:
  ...
  points:
    ...
    - titre: Accessibilité (RGAA)
      texte: Un service inclusif pour tous les publics.
    - titre: Outils métier complexes
      texte: Des parcours adaptés aux conseillers et recruteurs.
approche:
  titre: Une plateforme fiable et accessible
  points:
    - titre: Portail Liferay
      texte: Une base éprouvée pour les portails à grande échelle.
    - titre: Design system accessible
      texte: Conformité RGAA et cohérence d'interface.
    - titre: Recherche performante
