...
avatar: /uploads/articles/collab/guillaume-m.png
...
**L’intelligence artificielle (IA) s’impose désormais comme un pilier incontournable dans le développement des applications modernes.** 
...
Le *framework* PHP **Symfony** nous met à disposition un composant (officiel) simple et rapide pour intégrer ces outils dans nos applications : **[Symfony AI Bundle](https://symfony.com/doc/current/ai/bundles/ai-bundle.html)**.
